#
#  Be sure to run `pod spec lint SQLiteGTDB.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    SQLiteGTDB Support swift 4: wrapper SQLite.swift for sqlite db.
                   DESC

  s.homepage     = "http://EXAMPLE/SQLiteGTDB"
  ...
  s.source       = { :git => "https://git.petroun.com:20443/ios/sqlitegtdb.git", :tag => "#{s.version}" }
