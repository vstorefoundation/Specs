#
#  Be sure to run `pod spec lint GTQQSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
			Current SDK version -> 3.2.3
                   DESC

  s.homepage     = "http://EXAMPLE/GTQQSDK"
  ...
  s.source       = { :git => "http://gt.gitlab.com/xielb/GTQQSDK.git", :tag => "#{s.version}" }
